	...
	<div class="span6">
		<?php 
			if(isset($error)){
				...
				$num_post_perday = $user->num_post_perday;
				$genre = $user->genre;
				$site = $user->site;
		...
		<?php echo form_open_multipart('','class="form-horizontal"');?>
			<?php if($user->avatar != ''){ ?>
					<div>
					<img src="<?php echo base_url('images/th.php?src='.base_url('images/avatar/'.$user->avatar).'&w=50&h=50')?>" alt=""/>
					</div>
				<?php } ?>
			<div class="control-group">
				<label for="username">Username</label>
				<input  class="input-block-level" value="<?php echo $user_name; ?>" name="username" type="text"/>
			</div>
			<div class="control-group">
				<label for="username">Email</label>
				<input  class="input-block-level" value="<?php echo $email; ?>" name="email" type="text"/>
			</div>
			<div class="control-group">
